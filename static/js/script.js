    ...
    function displayResult(data) {
        ...
        resultContainer.innerHTML = `
            <div class="flex flex-col md:flex-row">
                <img src="${imageSrc}" alt="${data.title}" class="w-full md:w-1/3 rounded-lg shadow-lg" onerror="this.onerror=null; this.src='/static/img/placeholder.svg'; displayImageError();">
